    ...
    try:
        with open(filepath, 'r', encoding='utf-8-sig') as file:
            ...
            for line_number, line in enumerate(file, 1):
                ...
                if in_header:
                    if stripped_line.startswith('..'):
                        # Two-dot line indicates a new section, keep all dots
                        current_section = stripped_line.split()[0]  # This will keep all dots
                        ...
                        if current_section == '..TRANSPAR':  # Note: now checking for '..TRANSPAR' instead of 'TRANSPAR'
                            if attr_name == 'ENHET':
                        ...
                        elif current_section == '..OMRÅDE':  # Note: now checking for '..OMRÅDE'
                            if attr_name == 'MIN-NØ':
